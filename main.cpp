...
int main(int argc, char **argv)
{
  ...
  if(argc != 10) {
      ...
      printf("Correct syntax: exe inputfile outputfile NumConfig NumEqui NumAtom NumBin BoxLengthx Boxlengthy Boxlengthz\n");
      exit(0);
  }
  else {
      ...
      sscanf(argv[5], "%d", &NumberOfParticles);
      sscanf(argv[6], "%d", &NumberOfBins);
      sscanf(argv[7], "%f", &Lx);
      sscanf(argv[8], "%f", &Ly);
      sscanf(argv[9], "%f", &Lz);
  }
